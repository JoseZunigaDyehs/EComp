      ...
      <div id='form' style={{ opacity: '0' }} data-formuario={this.props.formulario}>
        ...
        <div className='mb-5'>
          ...
          <div className="custom-control custom-radio mb-3">
            <input type="radio" id="customRadio4" name="diasPago" className="custom-control-input" value="1" onChange={ValidarOpciones}/>
            <label className="custom-control-label" htmlFor="customRadio4">En menos de 15 días.</label>
          </div>
          <div className="custom-control custom-radio mb-3">
            <input type="radio" id="customRadio5" name="diasPago" className="custom-control-input" value="2" onChange={ValidarOpciones}/>
            <label className="custom-control-label" htmlFor="customRadio5">Entre 15 y 30 días.</label>
          </div>
          <div className="custom-control custom-radio mb-3">
            <input type="radio" id="customRadio6" name="diasPago" className="custom-control-input" value="3" onChange={ValidarOpciones}/>
            <label className="custom-control-label" htmlFor="customRadio6">Entre 31 y 45 días.</label>
          </div>
          <div className="custom-control custom-radio mb-3">
            <input type="radio" id="customRadio7" name="diasPago" className="custom-control-input" value="4" onChange={ValidarOpciones}/>
        ...
        <div className='mb-5'>
          <p className='fnt-14 c-gris mb-3 f-w-500' >Cuéntanos si tienes sugerencias o si tuviste algún problema. (Opcional)</p>
          <textarea className='w-100' cols="20" rows="5" id='sugerencias' onChange={ValidarSugerencias}>
